...
pdf("/media/nikitos/A820EB5420EB2850/Users/nikit/OneDrive - The University of Colorado Denver/Thyroid_AI/manuscript/CNN_PRS_draft/figures/CNN_plus_PRS.pdf",
    width = 5, height = 5)
...
text(80, 40, labels=paste("DeLong p-value =", format.pval(testobj$p.value, digits = 2)), adj=c(0, .5))
...
# CNN alone or in combination with PRS plus PCs
pdf("/media/nikitos/A820EB5420EB2850/Users/nikit/OneDrive - The University of Colorado Denver/Thyroid_AI/manuscript/CNN_PRS_draft/figures/CNN_plus_PRS_PCs.pdf",
    width = 5, height = 5)
rocobj1 <- plot.roc(dat$class, dat$Prob_malign_by_nodule,
                    main="",
                    percent=TRUE,
...
# CNN alone or in combination with PRS plus PCs
pdf("/media/nikitos/A820EB5420EB2850/Users/nikit/OneDrive - The University of Colorado Denver/Thyroid_AI/manuscript/CNN_PRS_draft/figures/CNN_plus_PRS_Covariates.pdf",
    width = 5, height = 5)
rocobj1 <- plot.roc(dat$class, dat$Prob_malign_by_nodule,
                    main="",
                    percent=TRUE,
